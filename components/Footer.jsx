...
const Footer = ({ bottom, landing }) => {
    ...
    useEffect(() => {
        if (
            bottom + (footerRef?.current?.clientHeight || 120) <
            window.innerHeight
        ) {
            setPos(
                window.innerHeight - bottom - (footerRef?.current?.clientHeight || 120)
            );
        }
                ...
                <Grid container alignItems="center">
                    ...
                    <Grid item xs={7} lg={12}>
                        <Typography
                            ...
                            color="footer_title.main"
                        >
                            <b>Vip</b> is a simple application that helps you memorize and
                            store vocabulary, idioms or phrases quickly. Easy registration,
            ...
            <Grid item xs={14} mt={3} mb={5}>
                ...
                >
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item>
                                <Link href="/terms-of-use" passHref>
                                    <MuiLink underline="none" color="footer_link.main">
                                        Terms
                                    </MuiLink>
                                </Link>
                            </Grid>
                    ...
                    <Grid item xs={12} mt={2}>
                        ...
                        and{" "}
                        <MuiLink href="https://policies.google.com/terms" underline="hover">
                            Terms of Service
                        </MuiLink>{" "}
                        apply.
                    </Grid>
    ...
    return (
        <Grid container p={2}>
            ...
            {links.map((item, index) => {
                return (
                    <Grid item xs={12} key={`footer-title-${index}`} mt={1}>
