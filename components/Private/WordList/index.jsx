            ...
            >
              <ListItem>
                ...
                <Switch
                  edge="end"
                  onChange={(e, value) =>
                    handleChange("auto-fill", `${value.toString()}`)()
                  }
                  checked={
                    isExist("auto-fill")[0]
                      ? isExist("auto-fill")[1] === "true"
                      : true
                  }
                  inputProps={{
          ...
          <Paper variant="outlined" sx={gridSX}>
            ...
            >
              <ListItem>
                <ListItemIcon>
                  {(
                    isExist("public-words")[0]
                      ? isExist("public-words")[1] === "true"
                      : true
                  ) ? (
                    <PublicIcon />
                  ) : (
                ...
                <Switch
                  edge="end"
                  onChange={(e, value) =>
                    handleChange("public-words", `${value.toString()}`)()
                  }
                  checked={
                    isExist("public-words")[0]
                      ? isExist("public-words")[1] === "true"
...
const AutoFillLevel = ({
  ...
  <Collapse
    in={isExist("auto-fill")[0] ? isExist("auto-fill")[1] === "true" : true}
    timeout="auto"
    unmountOnExit
  >
    <ListItem>
